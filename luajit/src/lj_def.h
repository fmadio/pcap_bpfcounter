...
/* JIT compiler limits. */
#define LJ_MAX_JSLOTS	2500		/* Max. # of stack slots for a trace. */
#define LJ_MAX_PHI	320		/* Max. # of PHIs for a loop. */
#define LJ_MAX_EXITSTUBGR	80	/* Max. # of exit stub groups. */
